...
size_t aesd_circular_buffer_nr_entries(struct aesd_circular_buffer *buffer) {
    if (buffer->in_offs == buffer->out_offs)
        return buffer->full? AESDCHAR_MAX_WRITE_OPERATIONS_SUPPORTED : 0;
